...
resource "aws_cloudfront_origin_access_control" "s3_oac" {
  name                              = "S3_OAC"
  description                       = "Origin Access Control policy for S3"
...
resource "aws_cloudfront_distribution" "www_s3_distribution" {
  origin {
    domain_name = aws_s3_bucket.www_bucket.bucket_domain_name # aws_s3_bucket.www_bucket.bucket_regional_domain_name
